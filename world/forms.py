...
_FORMS = [
    ...
    _form(
        ...
        "any",
        5,
        desc="The legendary Potara earrings merge two fighters into one being. The fusion is nearly permanent, combining the best of both warriors.",
        pl=2.5,
        speed=1.25,
        damage=1.35,
        ki_efficiency=0.95,
        drain_tick=8,
        drain_tech=6,
        prereq={"trainer": "elder_kai", "quest": "potara_fusion_rites"},
        visuals={"aura": "aura_potara_gold", "shader": "godly_radiance", "hair_override": "potara_style"},
        gameplay={"fusion_type": "potara", "permanent_until_unfuse": True},
        aliases=["potara"],
        special_system="fusion",
    ),
    _form(
        "metamoran_fusion",
        "Metamoran Fusion",
        "any",
        4,
        desc="The Metamoran dance fuses two warriors into a single fighter for 30 minutes. The combined power exceeds even Potara fusion!",
        pl=2.8,
        speed=1.30,
        damage=1.40,
        ki_efficiency=0.90,
        drain_tick=10,
        drain_tech=8,
        prereq={"trainer": "metamoran_master", "quest": "metamoran_dance_teaching"},
        visuals={"aura": "aura_metamoran_prismatic", "shader": "rainbow_flare", "hair_override": "metamoran_style"},
        gameplay={"fusion_type": "metamoran", "duration_minutes": 30},
        aliases=["dance_fusion", "metamoran"],
        special_system="fusion",
    ),
    _form(
        "fusion_grade_super_saiyan",
        "Fusion Super Saiyan",
        "any",
        5,
        desc="A fused warrior tapping into Super Saiyan power. The combination of fusion multipliers with SSJ transformation creates devastating power.",
        pl=3.5,
        speed=1.35,
        damage=1.50,
        ki_efficiency=0.85,
        drain_tick=12,
        drain_tech=10,
        prereq={"requires_form": "super_saiyan", "fusion_training": True},
        visuals={"aura": "aura_fusion_ssj", "shader": "golden_divinity", "hair_override": "fusion_ssj"},
        gameplay={"fusion_type": "any", "requires_fusion": True},
        aliases=["fssj", "fusion_ssj"],
        special_system="fusion",
    ),
]
