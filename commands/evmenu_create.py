...
def create_character(caller, session, data):
    ...
    new_character.db.hp = 100
    new_character.db.hp_max = 100
    new_character.db.ki_current = 50
    new_character.db.ki_max = 50
    new_character.db.base_power = 50
    new_character.db.strength = 10
    new_character.db.speed = 10
    new_character.db.mastery = 10
    new_character.db.ki_control = 10
    
    # Initialize techniques - grant starter techniques
    from world.techniques import STARTER_TECHNIQUES
    new_character.db.known_techniques = list(STARTER_TECHNIQUES)
    new_character.db.equipped_techniques = list(STARTER_TECHNIQUES[:4])  # First 4 as equipped
    new_character.db.tech_mastery = {}
    new_character.db.tech_cooldowns = {}
    
    # Initialize combat state
    new_character.db.combat_target = None
    new_character.db.in_combat = False
    new_character.db.charge_stacks = 0
    new_character.db.statuses = {}
    
    # Initialize form state
    new_character.db.active_form = None
    new_character.db.form_mastery = {}
    
    # Initialize racial traits
    from world.racials import ensure_character_racials
    ensure_character_racials(new_character)
