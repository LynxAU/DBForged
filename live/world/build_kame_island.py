...
def create_kame_island():
    ...
    # Create Beach
    beach_south = make_room("Kame Island - Southern Beach",
    ...
    beach_north = make_room("Kame Island - Rear Beach",
    ...
    beach_east = make_room("Kame Island - Eastern Shore",
    ...
    beach_west = make_room("Kame Island - Western Shore",
